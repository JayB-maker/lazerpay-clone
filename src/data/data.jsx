export const navs = [{
    ...
    navItems: [{
        ...
        description: "Recieve crypto payments without writting a single line of code",
        link: "/",
    }, {
        icon: "fa-solid fa-eject",
        navItem:"Payment Buttons",
        description: "Integrate the lazerpay button at checkout to accept payments",
        link: "/",
    }, ]
}, {
    nav: "Use Case",
    navItems: [{
        ...
        navItem:"E-commerce",
        description: "Tap into endless possibilities of growth for your ecommerce store.",
        link: "/",
    }, {
    ...
    navItems: [{
        ...
        navItem:"Press",
        description: "Get company media assets, brand guidelines and other resources.",
        link: "/",
    }, ]
}, ]